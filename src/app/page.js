...
export default function Home() {
    const { user, isAdmin, logout, setIsLoginModalOpen } = useUser();
        ...
        <main className="min-h-screen bg-neutral-950 text-neutral-100 font-sans selection:bg-blue-500/30">
            ...
            <header className="border-b border-neutral-800 bg-neutral-950/50 backdrop-blur-xl sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    ...
                    <nav className="flex items-center gap-3 text-neutral-400 font-medium font-arabic">
                        {user ? (
                            <div className="flex items-center gap-3">
                                {isAdmin && (
                                    <a href="/admin" className="text-sm text-orange-400 bg-orange-400/10 border border-orange-500/20 hover:bg-orange-400/20 transition-colors px-4 py-2 rounded-full font-bold flex items-center gap-1.5">
                                ...
                                <a href="/profile" className="text-sm text-neutral-300 bg-neutral-900 border border-neutral-800 hover:bg-neutral-800 transition-colors px-4 py-2 rounded-full hidden sm:flex items-center gap-2">
